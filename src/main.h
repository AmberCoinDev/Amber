...
static const uint256 CheckPointBlock2 ("626241102cf26fc893e8efe2a3ef13808e2b4aab68573be7a69bea281d345fc9");
...
public:
    ...
    {
        // AmberCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // AmberCoin: get transaction coin age
...
public:
    ...
    // AmberCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // AmberCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // AmberCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // AmberCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // AmberCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // AmberCoin: block index flags
    enum  
    {

...
namespace Checkpoints
{
    ...
    // AmberCoin: synchronized checkpoint (centrally broadcasted)
    ...
    // AmberCoin: get last synchronized checkpoint
    ...
    // AmberCoin: only descendant of current sync-checkpoint is allowed
    ...
    // AmberCoin: reset synchronized checkpoint to last hardened checkpoint
...
// AmberCoin: verify signature of sync-checkpoint message
...
// AmberCoin: process synchronized checkpoint
